...
v0:
	...
	jr	$ra
v1:
	ulhu 	$v0, 6($s0)		# loading "v0" from registers character array. It is stored at indexes 6  and  7
	jr	$ra
a0:
	ulhu 	$v0, 8($s0)		# loading "v0" from registers character array. It is stored at indexes 8  and  9
	jr	$ra
a1:
	ulhu 	$v0, 10($s0)		# loading "v0" from registers character array. It is stored at indexes 10  and 11
	jr	$ra
a2:
	ulhu 	$v0, 12($s0)		# loading "v0" from registers character array. It is stored at indexes 12  and  13
	jr	$ra
a3:
	ulhu 	$v0, 14($s0)		# loading "v0" from registers character array. It is stored at indexes 14 and  15
	jr	$ra
t0:
	ulhu 	$v0, 16($s0)		# loading "v0" from registers character array. It is stored at indexes 16  and  17
	jr	$ra
t1:
	ulhu 	$v0, 18($s0)		# loading "v0" from registers character array. It is stored at indexes 18  and  19
	jr	$ra
t2:
	ulhu 	$v0, 20($s0)		# loading "v0" from registers character array. It is stored at indexes 20  and  21
	jr	$ra
t3:
	ulhu 	$v0, 22($s0)		# loading "v0" from registers character array. It is stored at indexes 22  and  23
	jr	$ra
t4:
	ulhu 	$v0, 24($s0)		# loading "v0" from registers character array. It is stored at indexes 24  and  25
	jr	$ra
t5:
	ulhu 	$v0, 26($s0)		# loading "v0" from registers character array. It is stored at indexes 26  and  27
	jr	$ra
t6:
	ulhu 	$v0, 28($s0)		# loading "v0" from registers character array. It is stored at indexes 28  and  29
	jr	$ra
t7:
	ulhu 	$v0, 30($s0)		# loading "v0" from registers character array. It is stored at indexes 30  and  31
	jr	$ra
s0:
	ulhu 	$v0, 32($s0)		# loading "v0" from registers character array. It is stored at indexes 32  and  33
	jr	$ra
s1:
	ulhu 	$v0, 34($s0)		# loading "v0" from registers character array. It is stored at indexes 34  and  35
	jr	$ra
s2:
	ulhu 	$v0, 36($s0)		# loading "v0" from registers character array. It is stored at indexes 36  and  37
	jr	$ra
s3:
	ulhu 	$v0, 38($s0)		# loading "v0" from registers character array. It is stored at indexes 38  and  39
	jr	$ra
s4:
	ulhu 	$v0, 40($s0)		# loading "v0" from registers character array. It is stored at indexes 40  and 41
	jr	$ra
s5:
	ulhu 	$v0, 42($s0)		# loading "v0" from registers character array. It is stored at indexes 42  and 43
	jr	$ra
s6:
	ulhu 	$v0, 44($s0)		# loading "v0" from registers character array. It is stored at indexes 44  and 45
	jr	$ra
	
s7:
	ulhu 	$v0, 46($s0)		# loading "v0" from registers character array. It is stored at indexes 46  and 47
	jr	$ra
t8:
	ulhu 	$v0, 48($s0)		# loading "v0" from registers character array. It is stored at indexes 48 and  49
	jr	$ra
t9:
	ulhu 	$v0, 50($s0)		# loading "v0" from registers character array. It is stored at indexes 50  and  51
	jr	$ra
k0:
	ulhu 	$v0, 52($s0)		# loading "v0" from registers character array. It is stored at indexes 52  and  53
	jr	$ra
k1:
	ulhu 	$v0, 54($s0)		# loading "v0" from registers character array. It is stored at indexes 54  and  55
	jr	$ra
gp:
	ulhu 	$v0, 56($s0)		# loading "v0" from registers character array. It is stored at indexes 56  and  57
	jr	$ra
sp:
	ulhu 	$v0, 58($s0)		# loading "v0" from registers character array. It is stored at indexes 58  and  59
	jr	$ra
fp:
	ulhu 	$v0, 60($s0)		# loading "v0" from registers character array. It is stored at indexes 60  and  61
	jr	$ra
ra:
	ulhu 	$v0, 62($s0)		# loading "v0" from registers character array. It is stored at indexes 62  and 63
	jr	$ra
