...
void main(void) {
    uint8_t song[30] = {69, 69, 69, 69, 69, 69, 67, 69, 69, 69, 69, 69, 69, 67, 69, 69, 69, 69, 69, 69, 64, 64, 64, 64, 64, 64, 64, 64, 64, 64};
...
# 220 "main_d11.c"
            ...
            case 'T':
                ...
                while ((EUSART1_is_rx_ready()) == 0){
                    ...
                    printf("Strike Velocity = %d    released.\r\n",velocity);
                }
            ...
            case 'M':
                ...
                while(PORTAbits.RA3 != 0) {
                    ...
                    if(2){
                        ...
                        noteOn(0x90, song[songIndex],velocity);
                        while (keyState != 0);
                        noteOn(0x80, song[songIndex], velocity);
                        songIndex += 1;
                        if (songIndex >= 30){
                            songIndex = 0;
                        }
