...
//*****************************************************************
// Name:    Devin Buzzetta and Jesus Ramirez
// Date:    Fall 2018
		...
		if (EUSART1_DataReady) {			// wait for incoming data on USART
            ...
            case't': 
                ...
                */
                ...
                for (i=0; i <N; i++){
                    if(sample[i] <= nominalHallPressed){
                        velocity = 128 - i;
                        break;
                    }
                    else if (i == 63){
                        velocity = 128 - (64 + (sample[i] - nominalHallPressed));
                    }
                }
                printf("Strike Velocity = %d\r\n",velocity);
            ...
            case 'T':
                ...
                while (EUSART1_DataReady == false){
                    ...
                    printf("Strike Velocity = %4u\t released.\r\n",velocity); //prints the strike velocity and released when the key becomes unpressed  
                }
            ...
            case 'M':
                ...
                //pitch=35;
                //instrument = 0; //may need to change this to the piano
                ...
                while(BOTTOM_BUTTON_GetValue() != 0) {
                    ...
                    //I think right here we need to do:
                    ...
                    if(PRESSED_WAIT){
                        ...
                        while (keyState != UNPRESSED);
                        noteOn(NOTEOFF, song[songIndex], velocity);
                        songIndex += 1;
