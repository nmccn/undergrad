...
%token EOF
%token <char> BLOCK_1_1 EXPR1_11_1 EXPR1_14_1 EXPR1_14_3 EXPR1_16_1 EXPR1_17_1 EXPR1_2_0 EXPR1_3_0 EXPR1_4_1 EXPR1_5_1 EXPR1_6_1 EXPR1_9_1 IDENT_LIST_1_1_0_0_0 LAMBDA1_0_4 LAMBDA1_0_5 LAMBDA1_0_7 STMT_2_1
%token <float> NUMBER
%token <string> EXPR1_10_1 EXPR1_12_1 EXPR1_13_1 EXPR1_15_0 EXPR1_15_2 EXPR1_8_1 IDENT1 STRING
...
%nonassoc EXPR1_14_3 /*(* 12 *)*/
%nonassoc EXPR1_14_1 /*(* 11 *)*/
%left EXPR1_12_1 EXPR1_13_1 /*(* 8 *)*/
%left EXPR1_8_1 EXPR1_9_1 EXPR1_10_1 EXPR1_11_1 /*(* 7 *)*/
%left EXPR1_6_1 /*(* 5 *)*/
%left EXPR1_4_1 EXPR1_5_1 /*(* 4 *)*/
%nonassoc EXPR1_2_0 EXPR1_3_0 /*(* 3 *)*/
%left EXPR1_17_1 /*(* 2 *)*/
%nonassoc EXPR1_16_1 /*(* 1 *)*/
/*(* ^^ highest precedence *)*/
...
| EXPR1_2_0 expr1Aux { UopExpr(get_current_pos (),NegUop,$2) }
...
| expr1Aux EXPR1_2_0 expr1Aux { BopExpr(get_current_pos (),$1,MinusBop,$3) }
...
| expr1Aux EXPR1_14_1 expr1Aux EXPR1_14_3 expr1Aux { IfExpr(get_current_pos (),$1,$3,$5) }
| EXPR1_15_0 EXPR1_17_1 EXPR1_15_2 EXPR1_16_1 expr1Aux LAMBDA1_0_4 { PrintExpr(get_current_pos (),$5) }
| expr1Aux EXPR1_16_1 expr_list LAMBDA1_0_4 { CallExpr(get_current_pos (), $1,$3) }
| expr1Aux EXPR1_17_1 IDENT1 { FieldExpr(get_current_pos (),$1,$3) }
...
lambda1Aux:
| FUNC_KW lambda1_0_1 EXPR1_16_1 ident_list LAMBDA1_0_4 LAMBDA1_0_5 block LAMBDA1_0_7 { ($2, List.map (fun v -> (v,None)) $4, $7, None) }
;
