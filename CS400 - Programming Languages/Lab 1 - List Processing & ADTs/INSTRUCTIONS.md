# Nicholas McClellan - Individual Lab #1 Repository
...
repository:
```
https://github.com/mines-csci400/f20a-user-nmcclellan-lab1.git
```
...
```
git remote add upstream https://github.com/mines-csci400/f20a-assignment-lab1.git
