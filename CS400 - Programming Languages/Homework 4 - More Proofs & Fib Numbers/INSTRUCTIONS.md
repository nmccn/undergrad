# Nicholas McClellan - Individual Homework #5 Repository
...
```
git clone https://github.com/mines-csci400/f20a-user-nmcclellan-hw05.git
cd f20a-user-nmcclellan-hw05
```
...
repository:
```
https://github.com/mines-csci400/f20a-user-nmcclellan-hw05.git
```
...
```
git remote add upstream https://github.com/mines-csci400/f20a-assignment-hw05.git
