# Nicholas McClellan - Individual Exam #2 Repository
...
```
git clone https://github.com/mines-csci400/f20a-user-nmcclellan-exam2.git
cd f20a-user-nmcclellan-exam2
```
...
repository:
```
https://github.com/mines-csci400/f20a-user-nmcclellan-exam2.git
```
...
```
git remote add upstream https://github.com/mines-csci400/f20a-assignment-exam2.git
