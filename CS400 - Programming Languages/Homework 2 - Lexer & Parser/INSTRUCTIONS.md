# Nicholas McClellan - Individual Homework #3 Repository
...
repository:
```
https://github.com/mines-csci400/f20a-user-nmcclellan-hw03.git
```
...
```
git remote add upstream https://github.com/mines-csci400/f20a-assignment-hw03.git
