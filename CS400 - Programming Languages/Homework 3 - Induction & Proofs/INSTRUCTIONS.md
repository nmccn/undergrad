# Nicholas McClellan - Individual Homework #4 Repository
...
```
git clone https://github.com/mines-csci400/f20a-user-nmcclellan-hw04.git
cd f20a-user-nmcclellan-hw04
```
...
repository:
```
https://github.com/mines-csci400/f20a-user-nmcclellan-hw04.git
```
...
```
git remote add upstream https://github.com/mines-csci400/f20a-assignment-hw04.git
