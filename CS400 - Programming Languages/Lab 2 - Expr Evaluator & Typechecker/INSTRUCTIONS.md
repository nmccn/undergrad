# Nicholas McClellan - Individual Lab #2 Repository
...
```
git clone https://github.com/mines-csci400/f20a-user-nmcclellan-lab2.git
cd f20a-user-nmcclellan-lab2
```
...
repository:
```
https://github.com/mines-csci400/f20a-user-nmcclellan-lab2.git
```
...
```
git remote add upstream https://github.com/mines-csci400/f20a-assignment-lab2.git
