      ...
      body: ListView(
        children: <Widget>[
          ListTile(
            ...
            trailing: (lessonsComplete >= 0) ? unlocked : locked,
            selected: (lessonsComplete >= 0) ? true : false,
            enabled: (lessonsComplete >= 0) ? true : false,
            onTap: () {
          ...
          ListTile(
            title: const Text("Lesson 0:", style: TextStyle(fontSize: 22)),
            subtitle: const Text('Demo Flashcards', style: TextStyle(fontSize: 22)),
          ...
          ListTile(
            ...
            subtitle: const Text('Alphabet Flashcards', style: TextStyle(fontSize: 22)),
            trailing: (lessonsComplete >= 1) ? unlocked : locked,
            selected: (lessonsComplete >= 1) ? true : false,
            enabled: (lessonsComplete >= 1) ? true : false,
            onTap: () {
          ...
          ListTile(
            ...
            subtitle: const Text('Vocabulary Flashcards', style: TextStyle(fontSize: 22)),
          ...
          ListTile(
            ...
            subtitle: const Text('Conjugated Forms Flashcards', style: TextStyle(fontSize: 22)),
          ...
          ListTile(
            title: const Text('Lesson 4:', style: TextStyle(fontSize: 22)),
            subtitle: const Text('Descriptive Adjectives Multiple Choice', style: TextStyle(fontSize: 22)),
          ...
          ListTile(
            title: const Text('Lesson 5:', style: TextStyle(fontSize: 22)),
            subtitle: const Text('Definite Article Multiple Choice', style: TextStyle(fontSize: 22)),
          ...
          ListTile(
            title: const Text('Lesson 6:', style: TextStyle(fontSize: 22)),
            subtitle: const Text('Ser Conjugation Multiple Choice', style: TextStyle(fontSize: 22)),
          ...
          ListTile(
            title: const Text('Lesson 7:', style: TextStyle(fontSize: 22)),
            subtitle: const Text('Singular Articles Multiple Choice', style: TextStyle(fontSize: 22)),
          ...
          ListTile(
            title: const Text('Lesson 8:', style: TextStyle(fontSize: 22)),
